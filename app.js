...
function restart() {
  ...
  // Quitar la clase "success" de la imagen "imgpokemon"
  document.getElementById("imgpokemon").classList.remove("success");

  // Generar número aleatorio de 0 a la cantidad de pokemons disponibles
  numero = Math.floor(Math.random() * pokemons.length);

  // Modificar el atributo "src" de "imgpokemon" con el "thumbnail" del Pokémon candidato
  document.getElementById("imgpokemon").src = pokemons[numero].thumbnail;
}
